# Business Model: Manufacture of fibre optic cables
...
## Classification
- Repository: `cloud-itonami-isic-2731` ([github.com/cloud-itonami/cloud-itonami-isic-2731](https://github.com/cloud-itonami/cloud-itonami-isic-2731))
- ISIC Rev.5: `2731` — Manufacture of fibre optic cables
- Domain: `:electrical-equipment/manufacturing`
- Social impact: :worker-safety :product-safety :network-infrastructure-reliability
- Actor: `:fibre-optic-cable-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
- Do not bypass the `:fibre-optic-cable-plant-operations-governor` for production decisions.
