# Operator Quickstart — Manufacture of fibre optic cables

Shortest path from clone to a verified local dry-run for **ISIC 2731** (`cloud-itonami-isic-2731`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2731.git
cd cloud-itonami-isic-2731
```
...
- Blueprint governor key: `fibre-optic-cable-plant-operations-governor`
- Likely source path: `fibreopticmfg.governor.cljc`
