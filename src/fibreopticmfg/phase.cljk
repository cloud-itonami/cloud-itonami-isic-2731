(ns fibreopticmfg.phase
  "Phase 0->3 staged rollout for the ISIC 2731 (fibre optic cables:
  loose-tube, ribbon, tight-buffered, ADSS) plant-operations
  coordination actor.
  ...
  consequence (a drawing/coating/cabling-line-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `fibreopticmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Fibre Optic Cable Plant Operations Governor verdict to a base
