...
`cloud-itonami-isic-2731` is an OSS open-business blueprint for fibre-
optic-cable plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a drawing/coating/cabling-line-equipment action the governor refuses is never dispatched to hardware.
- the Fibre Optic Cable Plant Operations Governor remains independent of the advisor.
...
- bypassing drawing/coating/cabling-line-equipment-control or record policy checks
